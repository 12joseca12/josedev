...
export default function BlogNotFound() {
  return (
    <main id="main" className="mx-auto flex min-h-[50vh] max-w-3xl flex-col justify-center px-4 py-16 sm:px-6">
      <h1 className="font-headline text-2xl font-bold text-on-surface">{t(locale, "blog.ui.postNotFoundTitle")}</h1>
      <p className="mt-3 text-on-surface-variant">{t(locale, "blog.ui.postNotFoundBody")}</p>
      <p className="mt-8">
        <Link href={localizedHref(locale, "/blog")} className="font-semibold text-primary hover:underline">
