...
export function PhoneDeviceFrame({ children, label }: Props) {
  return (
    <div
      ...
      aria-label={label}
    >
      <div className="relative rounded-[2.25rem] border-[3px] border-dash-border/50 bg-device-frame-bezel p-2 shadow-[0_32px_80px_rgba(0,0,0,0.55),inset_0_0_0_1px_rgba(255,255,255,0.06)] sm:rounded-[2.5rem] sm:p-2.5">
        <div
